...
/// wave that it belongs to. 
/// </summary>
[AddComponentMenu("Visualizer Studio/Modifiers/Wave Property Modifier")]
public class VisWavePropertyModifier : VisBasePropertyModifier
{
    ...
    {
        public const WaveProperty param = WaveProperty.amp;
    }
