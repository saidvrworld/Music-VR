...
public static class VisPropertyHelper
{
    ...
    public static void SetWaveProperty(GameObject wave, WaveProperty targetProperty, float propertyValue)
    {
        int times = 3;
        if (wave == null)
        {
        ...
        {
            case WaveProperty.length:
                wave.GetComponent<LineWave>().lengh = propertyValue * 50;
                break;
            case WaveProperty.frequenscy:
                wave.GetComponent<LineWave>().freq = propertyValue * 5;
                break;
            case WaveProperty.amp:
                wave.GetComponent<LineWave>().amp = propertyValue * 10;
                break;
            case WaveProperty.warp:
                wave.GetComponent<LineWave>().warpRandom = propertyValue * times;
                break;
            case WaveProperty.speed:
                wave.GetComponent<LineWave>().walkAuto = propertyValue * times;
                break;
            case WaveProperty.FreqLeng:
                wave.GetComponent<LineWave>().lengh = propertyValue * 50;
                wave.GetComponent<LineWave>().freq = propertyValue * 20;
                break;
            case WaveProperty.LengAmp:
                wave.GetComponent<LineWave>().amp = propertyValue*10;
                wave.GetComponent<LineWave>().lengh = propertyValue * 30;
                break;

            case WaveProperty.LengSpeed:
                wave.GetComponent<LineWave>().lengh = propertyValue * 20;
                wave.GetComponent<LineWave>().walkAuto = propertyValue * 20;
                break;
            default:
                break;
